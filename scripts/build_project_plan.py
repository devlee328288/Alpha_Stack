...
#: 다시 계산했다. 기준선 = 평가구간 최빈 클래스(두 트랙 모두 상승).
RESULT_ROWS = [
    ["지표", "KOSPI200 · 조합 C", "개별종목 · 조합 K"],
    ["평가 표본", "478거래일", "23,567건"],
    ["정확도", "0.4331", "0.3807"],
    ["같은 기간 기준선\n(평가구간 최빈 = 상승)", "0.5460 (261 / 478)", "0.3655 (8,614 / 23,567)"],
...
LIMIT_ROWS = [
    ["무엇", "지금", "발전 방향"],
    ["KOSPI200 트랙이 같은 기간 기준선을 넘지 못했다",
     "상승이 54.6% 인 2년에서 정확도 0.4331 · MCC −0.01",
     "결과를 보고 설정을 바꾸지 않는다.\n"
...
def appendix_blocks() -> List[Block]:
    ...
    b += [
        ...
        ("blank",),
        ("para", "· 개별종목은 같은 기간 기준선을 +1.52%p 넘었다. KOSPI200 은 평가구간의 "
                 "54.6% 가 상승이었고, 모델은 그 기준선을 넘지 못했다(MCC −0.01). 결과를 "
                 "본 뒤 모델·피처·임계값을 다시 고르지 않았다.", 9.0, False),
        ("para", "· 기준선은 같은 기간 안에서 잰다. 개발구간 기준선(KOSPI200 0.3972 · "
                 "개별종목 0.3969)과 홀드아웃 정확도를 나란히 놓으면 기간이 섞여 "
                 "결론이 뒤집힌다.", 9.0, False),

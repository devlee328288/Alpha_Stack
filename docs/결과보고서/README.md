...
>
> 🆕 **2026-09-14 — v1.1 이 1차 프로젝트의 결과 보고서입니다.** 강사님 계획서 양식(구분 · 내용 · 비고)을
...
PNG 를 굽습니다. v1.1 은 그림을 바꾸지 않아 빌더의 `FIG_DIR` 이 v1.0 폴더를 그대로 가리킵니다 — 그림을 고치는 판에서만 새 버전 폴더에 둡니다. 숫자 원본과 색 검증 결과는 각 HTML 머리 주석에 있습니다. 시스템 구성도는

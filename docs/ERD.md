...
## 3. 현재 데이터 규모 (원본 실측 · 2026-08-25)

| 항목 | 값 |
|---|---|
| 거래일 | **297일** (2025-06-09 ~ 2026-08-24) |
| 전종목 시세 | **821,928행** · 2,875종목 · 111.9MB |
| core 유니버스 | **350종목** (KOSPI200 200 + KOSDAQ150 150) |
| core 시세 | 103,663행 |

> ⚠️ **학습에는 얇습니다.** 297거래일은 워크포워드 폴드를 충분히 만들기 어렵습니다.
> `evaluation.walk_forward` 의 기본 `min_train` 이 120이라, 297일이면 검증에 쓸
> 구간이 얼마 남지 않습니다. **과거 백필이 먼저입니다** → [회의안건 A-3](회의안건.md)

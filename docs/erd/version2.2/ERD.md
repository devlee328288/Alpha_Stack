# ERD — AlphaStack 데이터 모델 (v2.2)

> **정본은 [`ingest/store/migrations.py`](../../../ingest/store/migrations.py) 입니다.**
> 이 문서가 코드와 어긋나면 마이그레이션 코드가 맞습니다.
> v2.2 · 2026-09-03 · 이전 판 [v2.1](../version2.1/ERD.md) · [v2.0](../version2.0/ERD.md) ·
> [v1.0](../version1.0/ERD.md) · [변경사항](변경사항.md)
>
> 실측 기준: `krx_cache.db` **스키마 v10 · 표 19개** (2026-09-03,
...
## 1. 한눈에 — 표 19개를 여섯 묶음으로

자료 표 5개 · **신원 표 2개(v10)** · 운영 표 12개입니다.
...
┌── 신원 = 다리 (v10 · 공공데이터포털) ────────────────────────────┐
│                                                                  │
│  stock_identity   코드 ↔ crno ↔ ISIN                            │
│  corp_profile     상장일 · 폐지일 · 감사의견 · 종업원수           │
│                                                                  │
...
행 수는 2026-09-03 실측입니다. 수집이 돌면 움직입니다.
...
| v11 | 다음 빈 번호 (텍스트 신호 `text_signal` 예정 — **선착순이라 확정이 아니다**) |

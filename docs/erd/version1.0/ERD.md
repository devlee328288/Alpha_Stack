...
어떻게 다룰지 정해야 합니다 → [회의안건 A-3](../../회의안건/2026-09-01-킥오프.md)
...
> ✅ **갱신됨.** 이전 판은 이동원 개인 원본 저장소 수치(297거래일 · 821,928행)를 적었습니다.
...
- 팀 Supabase 를 팔 것인가, 이 스키마를 그대로 쓸 것인가 → [회의안건 A-1](../../회의안건/2026-09-01-킥오프.md)
...
- 예측 결과·백테스트 성과를 DB 에 남길 것인가, 파일로 둘 것인가
  → 대시보드 연결 방식과 함께 정합니다 → [회의안건 B-3](../../회의안건/2026-09-01-킥오프.md)

...
| `1_Baseline` | ① **ADAPTIVE** — 6-파라미터 동적 기준선 · 12폴드 · CMA-ES QUICK(30) / FULL(300) · 임계 1% / 2% (폴드마다 α/β 재최적화) ② 🆕 **FROZEN CLASSIFIER** — 전체 구간에서 CMA-ES 한 번 → 고정 α/β 한 세트 · 목적 조화평균(ACC·F1·하락 재현율) 또는 F1 · 연도별 안정성 (PR #269 · 이슈 #263 1차 구현) | `evaluation/threshold_tuning/step5_optimize_6params.py` — `run_walkforward_6params` · 🆕 `find_frozen_6params` · `make_baseline_labels` |

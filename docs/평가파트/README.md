...
| 버전 | 날짜 | 무엇이 담겼나 |
|---|---|---|
| [**version1.3**](version1.3/) ⭐ | 2026-09-14 | 🆕 [대시보드 9페이지와 배포](version1.3/대시보드_9페이지와_배포.md) — **화면 안에서 학습하는 연구 단말**(Baseline CMA-ES · Model Lab 4모델 워크포워드 · Backtest · Cost Sens · Risk · Universe · QFRS · PR #261 · #262) · 결과 캐시는 모듈 전역이라 재시작 전까지 모든 접속자 공유 · 배포 기록(Streamlit Cloud: 요구사항 파일 PR #266 · `HF_TOKEN` 이름 · CPU 제한 → HF Space Docker 로컬 검증) · 논의 이슈 5건 · ruff `dashboard/` 199 ([변경사항](version1.3/변경사항.md)) |

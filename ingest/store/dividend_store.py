...
크기를 쟀다 — 배당락일의 평균 일간수익률이 평소보다 **0.455%p 낮고 15년 중 11년이 음수**다
(퀀트기준 대조 §3.2). 개별종목 중립대가 ±2% 이므로, 5거래일 라벨 창에 배당락일이 들어오면
그 라벨이 조용히 아래로 밀린다. **"하락" 으로 세어진 것 중 일부는 배당을 받은 것**이다.

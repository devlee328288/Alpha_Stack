...
| **v9** | 수정주가 (`daily_price.adj_*`) · 거래일 달력 | **적용됨** (2026-09-02) |
| **v10** | 종목 신원 · 법인 개요 (`stock_identity` · `corp_profile`) | **적용됨** (2026-09-03) |
| **v11** | 종목기본정보 (`stock_base_info` · 우선주 판별의 정본) | **적용됨** (2026-09-03) |
| **v12** | 텍스트 신호 (`text_signal` · 공시 제목 → 확률 3칸) | **적용됨** (2026-09-04) |
| **v13** | 지수 기본키에 시장 (`index_price` PK + `index_class`) | **적용됨** (2026-09-07) |
| **v14** | 배당 (`dividend` · 현금·주식배당과 배당락일) | **적용됨** (2026-09-09) |
| **v15** | 총수익 (`daily_price.adj_close_tr` · `adj_dividend`) | **적용됨** (2026-09-10) |
| **v16** | 기업행위 (`corporate_action` · 자본 사건 표와 chain 대조) | **적용됨** (2026-09-10) |
| v17 | 다음 빈 번호 | — |
...
#: v16 을 기업행위가 가져갔으므로 빈 자리는 v17 이다.
NEXT_MIGRATION_VERSION = 17

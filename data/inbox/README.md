...
> 🔴 **팀장이 사이트에서 손으로 받아 온 것은 여기가 아닙니다.**
> → [`data/manual/`](../manual/README.md)
>
> 축이 다릅니다 — 여기는 *"팀원이 준 것"*, 저기는 *"내가 받아 온 것"* 입니다.
> 한 폴더에 섞여 있으면 값이 우리 것과 다를 때 **누구에게 물어야 하는지** 알 수 없습니다.
> 받는 방법은 [직접 수집 가이드](../../docs/데이터파트/version2.3/직접수집_가이드.md)에 있습니다.

...
| **정적 HTML 리포트** | 신규 예정 | 인터랙티브 대시보드는 **1차 범위 밖**으로 내렸습니다 ([요구사항 F-27](docs/요구사항.md)) |
...
| 문서 | 내용 |
|---|---|
| [docs/문제정의.md](docs/문제정의.md) | ★ **왜 만드나 · 무엇이 성공인가** (계획서보다 앞섭니다) |
| [docs/요구사항.md](docs/요구사항.md) | ★ **무엇을 만드나** — 기능 29건 · 데이터 요구사항 12건 |
| [docs/시장조사.md](docs/시장조사.md) | 근거 — 국내외 서비스 · 선행연구 · 한국 제도 제약 |
| [docs/합류전-준비물.md](docs/합류전-준비물.md) | 팀원이 킥오프 전에 할 것 (KRX 키 발급) |
| [docs/TIL/](docs/TIL/) | 작업 기록 |
